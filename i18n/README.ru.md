...
| **Windows 10/11 (x64)** | `_x64_en-US.msi` | На данный момент без подписи (может появиться предупреждение SmartScreen) |
| **Windows 10/11 (ARM64)** | `_arm64_en-US.msi` | На данный момент без подписи (может появиться предупреждение SmartScreen) |
| **Ubuntu/Debian (amd64)** | `_amd64.deb` | Для лучшей поддержки воспроизведения видео см. примечание для Linux ниже. |
