...
| **Windows 10/11 (x64)** | `_x64_en-US.msi` | 目前暂无签名 (可能会显示 SmartScreen 警告) |
| **Windows 10/11 (ARM64)** | `_arm64_en-US.msi` | 目前暂无签名 (可能会显示 SmartScreen 警告) |
| **Ubuntu/Debian (amd64)** | `_amd64.deb` | 关于视频播放支持，请参阅下方的 Linux 备注。 |
